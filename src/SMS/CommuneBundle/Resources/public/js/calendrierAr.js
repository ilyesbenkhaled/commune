...
var day_of_week = new Array('أحد','إثنين','ثلاثاء','إربعاء','خميس','جمعة','سبت');
var month_of_year = new Array('جانفي','فيفري','مارس','أفريل','ماي','جوان','جويلية','أوت','سبتمبر','أكتوبر','نوفمبر','ديسمبر');
...
var TR_start = '<TR>';
var TR_end = '</TR>';
var highlight_start = '<TD WIDTH="30"><TABLE style="font-size: 8px;" CELLSPACING=0 BORDER=1 BGCOLOR=6EA7B1 BORDERCOLOR=DDE4F0><TR><TD WIDTH=20><B><CENTER>';
...
cal =  '<TABLE style="font-size: 8px;" BORDER=1 CELLSPACING=0 CELLPADDING=0 BORDERCOLOR=C5C7CB><TR><TD>';
cal += '<TABLE style="font-size: 8px;" BORDER=0 CELLSPACING=0 CELLPADDING=2>' + TR_start;
cal += '<TD COLSPAN="' + DAYS_OF_WEEK + '" BGCOLOR="#6EA7B1"><CENTER><B>';
